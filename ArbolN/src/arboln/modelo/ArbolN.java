...
public class ArbolN implements Serializable{
    ...
    /*
    metodo para agregar in nodo nuevo al arbol
    este lanza un mensaje si ya existe el dato o si el padre no axixte
    */
    ...
    /*
    metodo calcular genero
    temporal jefe
    aumente el genero en +1 
    */
