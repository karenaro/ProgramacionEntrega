...
public class ArbolNarioControlador implements Serializable {
    ...
    private void inicializar()
    {
        ...
        ciudades.add(new SelectItem(1, "Tumaco"));
        ciudades.add(new SelectItem(2, "Cartagena"));
        ciudades.add(new SelectItem(3, "Caucaca"));
        ciudades.add(new SelectItem(4, "Pasto"));
        ciudades.add(new SelectItem(5, "Manizales"));
    }
